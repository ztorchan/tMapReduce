...
constexpr WorkerState WorkerState_MIN = UNKNOWN;
constexpr WorkerState WorkerState_MAX = CLOSE;
constexpr int WorkerState_ARRAYSIZE = WorkerState_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* WorkerState_descriptor();
template<typename T>
inline const std::string& WorkerState_Name(T enum_t_value) {
  static_assert(::std::is_same<T, WorkerState>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function WorkerState_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    WorkerState_descriptor(), enum_t_value);
}
inline bool WorkerState_Parse(
    const std::string& name, WorkerState* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<WorkerState>(
